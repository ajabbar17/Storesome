...
export default function Production({ data, link }) {
  ...
  return (
    <div className="p-6 ml-14">
      ...
      <div className="bg-white shadow-xl shadow-slate-300 rounded-lg">
        <div className="px-6 py-4 text-xl font-semibold border-b">Production</div>
            ...
            {data.map((product, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <td className="flex justify-end px-6 py-3 space-x-2">
                  ...
                  <button className="px-2 w-1/3 py-2 text-xs font-medium text-white bg-green-500 rounded hover:bg-green-600">
                    Add Shipment
                  </button>
